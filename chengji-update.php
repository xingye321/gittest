				...
				<form id="form1" action="chengji-save.php" method="post" class="sui-form form-horizontal sui-validate">
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="text" value="<?php echo $row['学号'] ?>" id="xuehao" name="xuehao" class="input-large input-fat" placeholder="请输入学号" data-rules="required|minlegth=2|maxlength=10">
						</div>
					</div>
					<div class="control-group">
						<label for="inputEmail" class="control-label">课程编号：</label>
						<div class="controls">
							<input type="text" value="<?php echo $row['课程编号'] ?>" id="bianhao" name="bianhao" class="input-large input-fat" placeholder="请输入学号" data-rules="required|minlegth=2|maxlength=10">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" value="<?php echo $row['成绩'] ?>" id="chengji" name="chengji" class="input-large input-fat" placeholder="请输入成绩" data-rules="required|minlegth=2|maxlength=10">
						</div>
					</div>
					<div class="control-group">
