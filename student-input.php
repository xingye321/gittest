			...
			<div class="content">
				...
				<form id="form1" action="student-save.php" method="post" class="sui-form form-horizontal sui-validate" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="compellation" name="compellation" class="input-large input-fat" placeholder="请输入姓名" data-rules="required|minlegth=2|maxlength=10">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="phone" name="phone" class="input-large input-fat" placeholder="请输入电话" data-rules="required|minlegth=2|maxlength=10">
						</div>
					</div>
					<div class="control-group">
